...
def problem5(seq_of_seq):
    ...
    for k in range(len(seq_of_seq)):
        for j in range(len(seq_of_seq[k])):
            if largest_integer == '':
                largest_integer = seq_of_seq[k][j]
            else:
                if largest_integer < seq_of_seq[k][j]:
                    largest_integer = seq_of_seq[k][j]
        if largest_integer != '':
            new_list_problem5 = new_list_problem5 + [largest_integer]
        largest_integer = ''
    return new_list_problem5
